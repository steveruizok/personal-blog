...
What we really want is a method that ensures that only the _moving_ items will require new `index` values. Luckily for us, we do have such a method: _fractional indexing_.
