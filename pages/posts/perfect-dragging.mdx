...
So in this post, I'm going to quickly cover how to drag a shape on a canvas, or in an application that uses some kind of [zoom ui](/posts/zoom-ui). While it seems simple, implementing this feature the wrong way can make other features (like snapping) much more difficult later on.
