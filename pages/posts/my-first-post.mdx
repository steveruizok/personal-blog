...
title: 'Heya world!'
date: '08/29/2020'
hero: '/images/image-0.jpg'
description: "Well, this is an interesting post! It's my first one. And, as such, given that this is my first post, I should really write a longer introduction—both to myself, and to the post! So, here I go."
---

# An h1 header

Since day [one we’ve](/posts/my-second-post) been dogfooding our own tools, while letting components drive our architecture and development process. A great advantage of [this is the ability](https://google.com/) to enjoy the benefits of Micro Front-Ends.
...
![example image](/images/image-0.jpg 'Wow, what an image!')
