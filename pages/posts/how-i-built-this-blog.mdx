...
Later on, I switched to [Stiches](http://stitches.dev), a newly released library by the team at [Modulz](https://www.modulz.app/).[^4] Like theme-ui, it follows Jackson's theme specification; however, it has its own styling engine.
